---@meta MouseEventDelegate
---@class MouseEventDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): MouseEventDelegate
---@field Invoke fun(e: MouseEvent): nil
---@field BeginInvoke fun(e: MouseEvent, callback: AsyncCallback, object: table): IAsyncResult
