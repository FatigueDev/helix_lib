---@meta GuiElementTextArea
---@class GuiElementTextArea: GuiElementEditableTextBase
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, OnTextChanged: any`1, font: CairoFont): GuiElementTextArea
...
---@field SetFont fun(cairoFont: CairoFont): nil
