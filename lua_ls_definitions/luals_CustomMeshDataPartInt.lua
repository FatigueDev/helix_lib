---@meta CustomMeshDataPartInt
---@class CustomMeshDataPartInt: CustomMeshDataPart`1
---@field ctor fun(): CustomMeshDataPartInt
---@overload fun(size: number): CustomMeshDataPartInt
---@field Clone fun(): CustomMeshDataPartInt
---@field EmptyClone fun(): CustomMeshDataPartInt
