---@meta Func`5
---@class Func`5: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): Func`5
---@field Invoke fun(t1: T1, t2: T2, t3: T3, t4: T4): TResult
---@field BeginInvoke fun(t1: T1, t2: T2, t3: T3, t4: T4, callback: AsyncCallback, object: table): IAsyncResult
