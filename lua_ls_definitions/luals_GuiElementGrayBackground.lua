---@meta GuiElementGrayBackground
---@class GuiElementGrayBackground: GuiElement
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds): GuiElementGrayBackground
