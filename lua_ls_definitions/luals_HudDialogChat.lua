---@meta HudDialogChat
---@class HudDialogChat: HudElement
---@field ctor fun(capi: ICoreClientAPI): HudDialogChat
...
---@field IsOpened fun(dialogComposerName: string): boolean
---@field UnFocus fun(): nil
---@field OnGuiOpened fun(): nil
---@field OnGuiClosed fun(): nil
---@field TryClose fun(): boolean
---@field DoClose fun(): nil
---@field OnKeyPress fun(args: KeyEvent): nil
---@field OnKeyDown fun(args: KeyEvent): nil
---@field OnMouseUp fun(args: MouseEvent): nil
---@field GetHistoricalMessage fun(typedMessagesHistoryPos: number): string
---@field HandleClientCommand fun(message: string, groupid: number): nil
---@field HandleClientMessage fun(groupid: number, message: string): nil
