---@meta MainMenuRenderAPI
---@class MainMenuRenderAPI: RenderAPIBase
---@field ctor fun(screenManager: ScreenManager): MainMenuRenderAPI
...
---@field Render2DTexturePremultipliedAlpha fun(textureid: number, posX: Double, posY: Double, width: Double, height: Double, z: Single, color: Vec4f): nil
---@overload fun(textureid: number, x1: Single, y1: Single, width: Single, height: Single, z: Single): nil
---@overload fun(textureid: number, posX: Single, posY: Single, width: Single, height: Single, z: Single, color: Vec4f): nil
---@field Draw2DShadedEdges fun(posX: Single, posY: Single, width: Single, height: Single, z: Single): nil
