---@meta GuiElementPassiveItemSlot
---@class GuiElementPassiveItemSlot: GuiElement
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, inventory: IInventory, slot: ItemSlot, drawBackground: boolean): GuiElementPassiveItemSlot
...
---@field unscaledItemSize ElementBounds
---@field unscaledSlotSize ElementBounds
