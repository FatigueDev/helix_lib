---@meta SystemRenderEntities
---@class SystemRenderEntities: ClientSystem
---@field ctor fun(game: ClientMain): SystemRenderEntities
---@field OnRenderOpaque3D fun(deltaTime: Single): nil
