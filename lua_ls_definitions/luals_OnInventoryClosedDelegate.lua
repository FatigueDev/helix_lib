---@meta OnInventoryClosedDelegate
---@class OnInventoryClosedDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): OnInventoryClosedDelegate
---@field Invoke fun(player: IPlayer): nil
---@field BeginInvoke fun(player: IPlayer, callback: AsyncCallback, object: table): IAsyncResult
