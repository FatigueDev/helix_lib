---@meta SurfaceMusicTrack
---@class SurfaceMusicTrack: Object
---@field ctor fun(): SurfaceMusicTrack
...
---@field Sound Single
---@field ShouldPlayMusic Single
---@field globalCooldownUntilMs Single
---@field tracksCooldownUntilMs Single
SurfaceMusicTrack = {}
