---@meta OnAmbientSoundScanCompleteDelegate
---@class OnAmbientSoundScanCompleteDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): OnAmbientSoundScanCompleteDelegate
---@field Invoke fun(ambientSounds: any[]): nil
---@field BeginInvoke fun(ambientSounds: any[], callback: AsyncCallback, object: table): IAsyncResult
