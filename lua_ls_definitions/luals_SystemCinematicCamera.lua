---@meta SystemCinematicCamera
---@class SystemCinematicCamera: ClientSystem
---@field ctor fun(game: ClientMain): SystemCinematicCamera
---@field get_Name fun(): string
---@field OnRenderFrame3D fun(deltaTime: Single): nil
---@field OnFinalizeFrame fun(dt: Single): nil
---@field AdvanceTo fun(percent: Double): nil
