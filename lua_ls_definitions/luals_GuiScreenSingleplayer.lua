---@meta GuiScreenSingleplayer
---@class GuiScreenSingleplayer: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parent: GuiScreen): GuiScreenSingleplayer
---@field OnScreenLoaded fun(): nil
---@field OnBackPressed fun(): boolean
---@field OnCancel fun(): boolean
---@field PrettyTime fun(seconds: number): string
