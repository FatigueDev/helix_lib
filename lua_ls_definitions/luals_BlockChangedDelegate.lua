---@meta BlockChangedDelegate
---@class BlockChangedDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): BlockChangedDelegate
---@field Invoke fun(pos: BlockPos, oldBlock: Block): nil
---@field BeginInvoke fun(pos: BlockPos, oldBlock: Block, callback: AsyncCallback, object: table): IAsyncResult
