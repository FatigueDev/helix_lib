---@meta BlockAccessorRevertable
---@class BlockAccessorRevertable: BlockAccessorRelaxedBulkUpdate
---@field ctor fun(worldmap: WorldMap, worldAccessor: IWorldAccessor, synchronize: boolean, relight: boolean, debug: boolean): BlockAccessorRevertable
...
---@field StoreHistoryState fun(historyState: HistoryState): nil
...
---@field OnStoreHistoryState number
---@field OnRestoreHistoryState number
---@field BeforeCommit number
---@field StagedBlocks number
---@field LightSources number
