---@meta GuiElementElementListPickerBase`1
---@class GuiElementElementListPickerBase`1: GuiElementControl
---@field ctor fun(capi: ICoreClientAPI, elem: string, bounds: ElementBounds): GuiElementElementListPickerBase`1
---@field set_TooltipText fun(value: string): nil
---@field get_Focusable fun(): boolean
---@field ComposeElements fun(ctx: Context, surface: ImageSurface): nil
---@field DrawElement fun(elem: string, ctx: Context, surface: ImageSurface): nil
...
---@field SetValue fun(on: boolean): nil
