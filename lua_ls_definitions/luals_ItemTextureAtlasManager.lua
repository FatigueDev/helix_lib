---@meta ItemTextureAtlasManager
---@class ItemTextureAtlasManager: TextureAtlasManager
---@field ctor fun(game: ClientMain): ItemTextureAtlasManager
---@field GetPosition fun(item: Item, textureName: string, returnNullWhenMissing: boolean): TextureAtlasPosition
---@field ResolveTextureCodes fun(item: Item, itemShapes: table<any, any>): nil
