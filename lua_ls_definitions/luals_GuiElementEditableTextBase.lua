---@meta GuiElementEditableTextBase
---@class GuiElementEditableTextBase: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, font: CairoFont, bounds: ElementBounds): GuiElementEditableTextBase
...
---@field OnTryTextChangeDelegate number
