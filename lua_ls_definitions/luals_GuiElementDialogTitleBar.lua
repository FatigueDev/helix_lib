---@meta GuiElementDialogTitleBar
---@class GuiElementDialogTitleBar: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, text: string, composer: GuiComposer, OnClose: Action, font: CairoFont, bounds: ElementBounds): GuiElementDialogTitleBar
---@field get_Movable fun(): boolean
...
---@field unscaledCloseIconSize boolean
