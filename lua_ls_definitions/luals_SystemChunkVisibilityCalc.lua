---@meta SystemChunkVisibilityCalc
---@class SystemChunkVisibilityCalc: ClientSystem
---@field ctor fun(game: ClientMain): SystemChunkVisibilityCalc
...
---@field AllSidesOpaque fun(block: Block): boolean
---@field DidWeExitChunk fun(posX: number, posY: number, posZ: number): boolean
