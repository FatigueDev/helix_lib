---@meta TextureDictionary
---@class TextureDictionary: FastSmallDictionary`2
---@field ctor fun(): TextureDictionary
---@overload fun(initialCapacity: number): TextureDictionary
---@field BakeAndCollect fun(manager: IAssetManager, mainTextureDict: ITextureLocationDictionary, sourceCode: AssetLocation, sourceMessage: string): nil
