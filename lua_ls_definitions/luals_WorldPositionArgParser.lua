---@meta WorldPositionArgParser
---@class WorldPositionArgParser: PositionArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, isMandatoryArg: boolean): WorldPositionArgParser
