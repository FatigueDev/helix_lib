---@meta ResumeServerDelegate
---@class ResumeServerDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): ResumeServerDelegate
---@field Invoke fun(): nil
