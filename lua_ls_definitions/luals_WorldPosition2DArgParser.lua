---@meta WorldPosition2DArgParser
---@class WorldPosition2DArgParser: PositionArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, isMandatoryArg: boolean): WorldPosition2DArgParser
