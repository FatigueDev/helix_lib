---@meta GuiScreenMultiplayerModify
---@class GuiScreenMultiplayerModify: GuiScreen
---@field ctor fun(serverentry: MultiplayerServerEntry, screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenMultiplayerModify
