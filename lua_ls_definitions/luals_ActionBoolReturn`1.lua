---@meta ActionBoolReturn`1
---@class ActionBoolReturn`1: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): ActionBoolReturn`1
---@field Invoke fun(t: T): boolean
---@field BeginInvoke fun(t: T, callback: AsyncCallback, object: table): IAsyncResult
