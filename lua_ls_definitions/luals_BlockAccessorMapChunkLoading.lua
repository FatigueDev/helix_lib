---@meta BlockAccessorMapChunkLoading
---@class BlockAccessorMapChunkLoading: BlockAccessorRelaxedBulkUpdate
---@field ctor fun(worldmap: WorldMap, worldAccessor: IWorldAccessor, synchronize: boolean, debug: boolean): BlockAccessorMapChunkLoading
...
---@overload fun(chunkCoord: Vec2i, chunksCol: IWorldChunk[]): nil
