---@meta GuiScreenMultiplayerNewServer
---@class GuiScreenMultiplayerNewServer: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenMultiplayerNewServer
