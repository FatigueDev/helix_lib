---@meta BlockCubeParticles
---@class BlockCubeParticles: CollectibleParticleProperties
---@field ctor fun(): BlockCubeParticles
---@overload fun(world: IWorldAccessor, blockpos: BlockPos, particlePos: Vec3d, radius: Single, quantity: number, scale: Single, velocity: Vec3f): BlockCubeParticles
