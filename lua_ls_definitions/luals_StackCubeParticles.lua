---@meta StackCubeParticles
---@class StackCubeParticles: CollectibleParticleProperties
---@field ctor fun(): StackCubeParticles
---@overload fun(collisionPos: Vec3d, stack: ItemStack, radius: Single, quantity: number, scale: Single, velocity: Vec3f): StackCubeParticles
