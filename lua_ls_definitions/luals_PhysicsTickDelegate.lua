---@meta PhysicsTickDelegate
---@class PhysicsTickDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): PhysicsTickDelegate
---@field Invoke fun(accum: Single, prevPos: Vec3d): nil
---@field BeginInvoke fun(accum: Single, prevPos: Vec3d, callback: AsyncCallback, object: table): IAsyncResult
