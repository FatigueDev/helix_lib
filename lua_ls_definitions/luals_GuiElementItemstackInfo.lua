---@meta GuiElementItemstackInfo
---@class GuiElementItemstackInfo: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, OnRequireInfoText: InfoTextDelegate): GuiElementItemstackInfo
---@field ComposeElements fun(ctx: Context, surface: ImageSurface): nil
---@field AsyncRecompose fun(): nil
---@field RenderInteractiveElements fun(deltaTime: Single): nil
---@field GetSlot fun(): ItemSlot
---@field SetSourceSlot fun(nowSlot: ItemSlot, forceRecompose: boolean): boolean
...
---@field Dirty string
---@field Render string
---@field titleElement string
---@field descriptionElement string
---@field texture string
---@field curSlot string
---@field onRenderStack string
---@field RecompCheckIgnoredStackAttributes string
---@field ItemStackSize string
---@field MarginTop string
---@field BoxWidth string
---@field MinBoxHeight string
