---@meta InventoryPlayerBackPacks
---@class InventoryPlayerBackPacks: InventoryBasePlayer
---@field ctor fun(className: string, playerUID: string, api: ICoreAPI): InventoryPlayerBackPacks
---@overload fun(inventoryId: string, api: ICoreAPI): InventoryPlayerBackPacks
