---@meta ModLogger
---@class ModLogger: LoggerBase
---@field ctor fun(parent: ILogger, mod: ModContainer): ModLogger
---@field get_Parent fun(): ILogger
---@field get_Mod fun(): ModContainer
...
---@field Mod ILogger
---@field TraceLog ILogger
---@field EntryAdded ILogger
ModLogger = {}
