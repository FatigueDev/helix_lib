---@meta ChunkLoadedDelegate
---@class ChunkLoadedDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): ChunkLoadedDelegate
---@field Invoke fun(chunkpos: Vec3i): nil
---@field BeginInvoke fun(chunkpos: Vec3i, callback: AsyncCallback, object: table): IAsyncResult
