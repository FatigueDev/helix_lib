---@meta PlayerInventoryNetworkUtil
---@class PlayerInventoryNetworkUtil: InventoryNetworkUtil
---@field ctor fun(inv: InventoryBase, api: ICoreAPI): PlayerInventoryNetworkUtil
---@field UpdateFromPacket fun(world: IWorldAccessor, packet: Packet_InventoryUpdate): nil
