---@meta EntityBehaviorNameTag
---@class EntityBehaviorNameTag: EntityBehavior
---@field ctor fun(entity: Entity): EntityBehaviorNameTag
---@field get_DisplayName fun(): string
---@field get_ShowOnlyWhenTargeted fun(): boolean
---@field set_ShowOnlyWhenTargeted fun(value: boolean): nil
---@field get_RenderRange fun(): number
---@field set_RenderRange fun(value: number): nil
---@field Initialize fun(entityType: EntityProperties, attributes: Jsontable): nil
---@field OnEntitySpawn fun(): nil
---@field SetName fun(playername: string): nil
...
---@field ShowOnlyWhenTargeted string
---@field RenderRange string
