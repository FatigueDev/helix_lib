---@meta OnSettingsChanged`1
---@class OnSettingsChanged`1: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): OnSettingsChanged`1
---@field Invoke fun(newValue: T): nil
---@field BeginInvoke fun(newValue: T, callback: AsyncCallback, object: table): IAsyncResult
