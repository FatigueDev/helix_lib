---@meta SystemScreenshot
---@class SystemScreenshot: ClientSystem
---@field ctor fun(game: ClientMain): SystemScreenshot
---@field get_Name fun(): string
---@field OnFrameDone fun(dt: Single): nil
---@field GetMetaData fun(): string
