---@meta ClientSystemEntities
---@class ClientSystemEntities: ClientSystem
---@field ctor fun(game: ClientMain): ClientSystemEntities
---@field get_Name fun(): string
---@field GetSystemType fun(): EnumClientSystemany
---@field createOrUpdateEntityFromPacket fun(entitypacket: Packet_Entity, game: ClientMain, addToLoadQueue: boolean): Entity
---@field entityPosFromPacket fun(packet: Packet_EntityPosition): EntityPos
