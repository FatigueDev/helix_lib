---@meta PlotDelegate3D
---@class PlotDelegate3D: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): PlotDelegate3D
---@field Invoke fun(x: number, y: number, z: number): nil
---@field BeginInvoke fun(x: number, y: number, z: number, callback: AsyncCallback, object: table): IAsyncResult
