---@meta GuiScreenSingleplayerModify
---@class GuiScreenSingleplayerModify: GuiScreen
---@field ctor fun(worldfilename: string, screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenSingleplayerModify
---@field initGui fun(savegame: SaveGame): nil
---@field OnCreateBackup fun(): boolean
