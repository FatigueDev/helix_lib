---@meta ChunkColumnUnloadDelegate
---@class ChunkColumnUnloadDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): ChunkColumnUnloadDelegate
---@field Invoke fun(chunkCoord: Vec3i): nil
---@field BeginInvoke fun(chunkCoord: Vec3i, callback: AsyncCallback, object: table): IAsyncResult
