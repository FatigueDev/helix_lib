---@meta GuiElementToggleButton
---@class GuiElementToggleButton: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, icon: string, text: string, font: CairoFont, OnToggled: any`1, bounds: ElementBounds, toggleable: boolean): GuiElementToggleButton
