---@meta GuiScreenSingleplayerNewWorld
---@class GuiScreenSingleplayerNewWorld: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenSingleplayerNewWorld
---@field OnScreenLoaded fun(): nil
---@field OnCustomize fun(): boolean
---@field GenRandomSurvivalName fun(): string
---@field GenRandomCreativeName fun(): string
