---@meta InventoryPlayerMouseCursor
---@class InventoryPlayerMouseCursor: InventoryBasePlayer
---@field ctor fun(className: string, playerUID: string, api: ICoreAPI): InventoryPlayerMouseCursor
---@overload fun(inventoryId: string, api: ICoreAPI): InventoryPlayerMouseCursor
