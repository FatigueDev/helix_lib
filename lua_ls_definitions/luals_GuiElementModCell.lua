---@meta GuiElementModCell
---@class GuiElementModCell: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, cell: ModCellEntry, bounds: ElementBounds, warningIcon: IAsset): GuiElementModCell
