---@meta BlockAccessorCaching
---@class BlockAccessorCaching: BlockAccessorRelaxed
---@field ctor fun(worldmap: WorldMap, worldAccessor: IWorldAccessor, synchronize: boolean, relight: boolean): BlockAccessorCaching
---@field get_LastChunkLoaded fun(): boolean
