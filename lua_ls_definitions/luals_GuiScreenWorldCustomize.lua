---@meta GuiScreenWorldCustomize
---@class GuiScreenWorldCustomize: GuiScreen
---@field ctor fun(didApply: any`1, screenManager: ScreenManager, parentScreen: GuiScreen, wcu: WorldConfig, playstyles: any[]): GuiScreenWorldCustomize
