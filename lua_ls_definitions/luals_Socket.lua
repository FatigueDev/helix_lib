---@meta Socket
---@class Socket: Object
---@field ctor fun(socketType: Socketany, protocolType: Protocolany): Socket
---@overload fun(addressFamily: AddressFamily, socketType: Socketany, protocolType: Protocolany): Socket
---@overload fun(handle: SafeSocketHandle): Socket
---@overload fun(socketInformation: SocketInformation): Socket
---@field get_SupportsIPv4 fun(): boolean
---@field get_SupportsIPv6 fun(): boolean
---@field get_OSSupportsIPv4 fun(): boolean
---@field get_OSSupportsIPv6 fun(): boolean
---@field get_OSSupportsUnixDomainSockets fun(): boolean
...
---@field Select fun(checkRead: IList, checkWrite: IList, checkError: IList, microSeconds: number): nil
---@overload fun(checkRead: IList, checkWrite: IList, checkError: IList, timeout: TimeSpan): nil
...
---@overload fun(socketType: Socketany, protocolType: Protocolany, e: SocketAsyncEventArgs): boolean
---@field CancelConnectAsync fun(e: SocketAsyncEventArgs): nil
...
---@field SupportsIPv4 boolean
---@field SupportsIPv6 boolean
---@field OSSupportsIPv4 boolean
---@field OSSupportsIPv6 boolean
---@field OSSupportsUnixDomainSockets boolean
