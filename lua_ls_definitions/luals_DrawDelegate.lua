---@meta DrawDelegate
---@class DrawDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): DrawDelegate
---@field Invoke fun(ctx: Context, surface: ImageSurface): nil
---@field BeginInvoke fun(ctx: Context, surface: ImageSurface, callback: AsyncCallback, object: table): IAsyncResult
