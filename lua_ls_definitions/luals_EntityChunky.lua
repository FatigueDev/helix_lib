---@meta EntityChunky
---@class EntityChunky: Entity
---@field ctor fun(): EntityChunky
---@field get_IsInteractable fun(): boolean
---@field get_ApplyGravity fun(): boolean
---@field CreateAndLinkWithDimension fun(sapi: ICoreServerAPI, dimension: IMiniDimension): EntityChunky
---@field AssociateWithDimension fun(blocks: IMiniDimension): nil
