---@meta InventoryDisplayed
---@class InventoryDisplayed: InventoryGeneric
---@field ctor fun(be: BlockEntity, quantitySlots: number, invId: string, api: ICoreAPI, onNewSlot: NewSlotDelegate): InventoryDisplayed
