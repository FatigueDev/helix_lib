---@meta AirBubbleParticles
---@class AirBubbleParticles: Object
---@field ctor fun(): AirBubbleParticles
...
---@field set_LifeLength fun(value: Single): nil
...
---@field AddVelocity boolean
---@field Range boolean
---@field quantity boolean
---@field horVelocityMul boolean
AirBubbleParticles = {}
