---@meta SystemHighlightBlocks
---@class SystemHighlightBlocks: ClientSystem
---@field ctor fun(game: ClientMain): SystemHighlightBlocks
---@field OnRenderFrame3DTransparent fun(deltaTime: Single): nil
