---@meta OnlinePlayerArgParser
---@class OnlinePlayerArgParser: ArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, isMandatoryArg: boolean): OnlinePlayerArgParser
