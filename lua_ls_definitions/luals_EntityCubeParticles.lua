---@meta EntityCubeParticles
---@class EntityCubeParticles: CollectibleParticleProperties
---@field ctor fun(): EntityCubeParticles
---@overload fun(world: IWorldAccessor, entityId: Int64, particlePos: Vec3d, radius: Single, quantity: number, minScale: Single, maxScale: Single): EntityCubeParticles
...
---@field particlePos boolean
---@field quantity boolean
---@field radius boolean
---@field minScale boolean
---@field maxScale boolean
---@field rand boolean
---@field api boolean
EntityCubeParticles = {}
