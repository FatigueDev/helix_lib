---@meta SystemNetworkProcess
---@class SystemNetworkProcess: ClientSystem
---@field ctor fun(game: ClientMain): SystemNetworkProcess
---@field get_Name fun(): string
---@field get_TotalBytesReceivedAndReceiving fun(): number
---@field OnSeperateThreadGameTick fun(dt: Single): nil
---@field SeperateThreadTickIntervalMs fun(): number
---@field NetworkProcess fun(): nil
---@field TryReadPacket fun(data: number[], dataLength: number): nil
...
---@field Name string
---@field TotalBytesReceivedAndReceiving string
---@field ServerPacketNames string
