---@meta SystemClientTickingBlocks
---@class SystemClientTickingBlocks: ClientSystem
---@field ctor fun(game: ClientMain): SystemClientTickingBlocks
---@field get_Name fun(): string
---@field OnBlockTexturesLoaded fun(): nil
---@field CommitScan fun(): nil
