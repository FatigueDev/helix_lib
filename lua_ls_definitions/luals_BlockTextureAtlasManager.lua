---@meta BlockTextureAtlasManager
---@class BlockTextureAtlasManager: TextureAtlasManager
---@field ctor fun(game: ClientMain): BlockTextureAtlasManager
---@field CollectAndBakeTexturesFromShape fun(compositeShape: Shape, targetDict: Itable<any, any>, baseLoc: AssetLocation): nil
---@field ResolveTextureCodes fun(block: Block, blockShapes: Orderedtable<any, any>, basicTexturesCache: table<any, any>): nil
---@field LoadAllTextureCodes fun(block: Block, blockShape: Shape): nil
