---@meta GuiElementSwitch
---@class GuiElementSwitch: GuiElementControl
---@field ctor fun(capi: ICoreClientAPI, OnToggled: any`1, bounds: ElementBounds, size: Double, padding: Double): GuiElementSwitch
