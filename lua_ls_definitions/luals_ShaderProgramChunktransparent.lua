---@meta ShaderProgramChunktransparent
---@class ShaderProgramChunktransparent: ShaderProgram
---@field ctor fun(): ShaderProgramChunktransparent
...
---@field set_ForcedTransparency fun(value: Single): nil
