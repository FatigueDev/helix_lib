---@meta GuiScreenServerResetWorld
---@class GuiScreenServerResetWorld: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenServerResetWorld
