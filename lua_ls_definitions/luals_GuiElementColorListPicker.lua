---@meta GuiElementColorListPicker
---@class GuiElementColorListPicker: GuiElementElementListPickerBase`1
---@field ctor fun(capi: ICoreClientAPI, elem: number, bounds: ElementBounds): GuiElementColorListPicker
---@field DrawElement fun(color: number, ctx: Context, surface: ImageSurface): nil
