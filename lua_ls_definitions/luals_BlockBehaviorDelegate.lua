---@meta BlockBehaviorDelegate
---@class BlockBehaviorDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): BlockBehaviorDelegate
---@field Invoke fun(behavior: BlockBehavior, handling: EnumHandling&): nil
---@field BeginInvoke fun(behavior: BlockBehavior, handling: EnumHandling&, callback: AsyncCallback, object: table): IAsyncResult
