---@meta WordRangeArgParser
---@class WordRangeArgParser: ArgumentParserBase
---@field ctor fun(argName: string, isMandatoryArg: boolean, words: string[]): WordRangeArgParser
