---@meta GuiDialogInventory
---@class GuiDialogInventory: GuiDialog
---@field ctor fun(capi: ICoreClientAPI): GuiDialogInventory
---@field get_DrawOrder fun(): Double
---@field get_ToggleKeyCombinationCode fun(): string
---@field OnOwnPlayerDataReceived fun(): nil
---@field ComposeGui fun(firstBuild: boolean): nil
