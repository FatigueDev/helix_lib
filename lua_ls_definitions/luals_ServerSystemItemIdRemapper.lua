---@meta ServerSystemItemIdRemapper
---@class ServerSystemItemIdRemapper: ServerSystem
---@field ctor fun(server: ServerMain): ServerSystemItemIdRemapper
---@field RemapItems fun(): nil
---@field LoadStoredItemCodesById fun(): table<any, any>
---@field StoreItemCodesById fun(storedItemCodesById: table<any, any>): nil
