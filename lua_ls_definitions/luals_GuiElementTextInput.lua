---@meta GuiElementTextInput
---@class GuiElementTextInput: GuiElementEditableTextBase
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, onTextChanged: any`1, font: CairoFont): GuiElementTextInput
