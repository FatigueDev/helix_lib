---@meta SystemRenderAim
---@class SystemRenderAim: ClientSystem
---@field ctor fun(game: ClientMain): SystemRenderAim
---@field get_Name fun(): string
---@field OnBlockTexturesLoaded fun(): nil
---@field OnRenderFrame2DOverlay fun(deltaTime: Single): nil
