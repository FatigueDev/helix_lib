---@meta ItemSlotCraftingOutput
---@class ItemSlotCraftingOutput: ItemSlotOutput
---@field ctor fun(inventory: InventoryBase): ItemSlotCraftingOutput
---@field TryPutInto fun(sinkSlot: ItemSlot, op: ItemStackMoveOperation&): number
---@field TryPutIntoNoEvent fun(sinkSlot: ItemSlot, op: ItemStackMoveOperation&): number
