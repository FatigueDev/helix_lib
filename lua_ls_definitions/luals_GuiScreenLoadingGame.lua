---@meta GuiScreenLoadingGame
---@class GuiScreenLoadingGame: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenLoadingGame
