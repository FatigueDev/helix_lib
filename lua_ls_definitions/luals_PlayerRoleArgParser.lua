---@meta PlayerRoleArgParser
---@class PlayerRoleArgParser: ArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, isMandatoryArg: boolean): PlayerRoleArgParser
