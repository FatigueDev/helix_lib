---@meta GuiScreenServerDashboard
---@class GuiScreenServerDashboard: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenServerDashboard
