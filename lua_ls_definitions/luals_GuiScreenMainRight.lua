---@meta GuiScreenMainRight
---@class GuiScreenMainRight: GuiScreen
---@field ctor fun(screenManager: ScreenManager, parent: GuiScreen): GuiScreenMainRight
---@field OnScreenLoaded fun(): nil
---@field Compose fun(): nil
---@field RenderToDefaultFramebuffer fun(dt: Single): nil
---@field Render fun(dt: Single, ellapsedMs: Int64, onlyBackground: boolean): nil
