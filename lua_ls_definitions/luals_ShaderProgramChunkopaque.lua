---@meta ShaderProgramChunkopaque
---@class ShaderProgramChunkopaque: ShaderProgram
---@field ctor fun(): ShaderProgramChunkopaque
...
---@field set_HaxyFade fun(value: number): nil
