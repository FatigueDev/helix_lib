---@meta GuiElementCompactScrollbar
---@class GuiElementCompactScrollbar: GuiElementScrollbar
---@field ctor fun(capi: ICoreClientAPI, onNewScrollbarValue: any`1, bounds: ElementBounds): GuiElementCompactScrollbar
...
---@field scrollbarPadding boolean
