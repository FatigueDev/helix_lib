---@meta GuiScreenDownloadMods
---@class GuiScreenDownloadMods: GuiScreen
---@field ctor fun(connectdata: ServerConnectData, installPath: string, modsToDownload: any[], screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenDownloadMods
