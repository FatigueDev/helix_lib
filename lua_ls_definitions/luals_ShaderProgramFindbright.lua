---@meta ShaderProgramFindbright
---@class ShaderProgramFindbright: ShaderProgram
---@field ctor fun(): ShaderProgramFindbright
---@field set_ColorTex2D fun(value: number): nil
---@field set_GlowTex2D fun(value: number): nil
---@field set_ExtraBloom fun(value: Single): nil
