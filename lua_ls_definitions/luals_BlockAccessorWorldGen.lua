---@meta BlockAccessorWorldGen
---@class BlockAccessorWorldGen: BlockAccessorBase
---@field ctor fun(server: ServerMain, chunkdbthread: ChunkServerThread): BlockAccessorWorldGen
