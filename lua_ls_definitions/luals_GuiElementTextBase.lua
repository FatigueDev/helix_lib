---@meta GuiElementTextBase
---@class GuiElementTextBase: GuiElementControl
---@field ctor fun(capi: ICoreClientAPI, text: string, font: CairoFont, bounds: ElementBounds): GuiElementTextBase
