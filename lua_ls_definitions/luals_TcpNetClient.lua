...
---@field ctor fun(platform: ClientPlatformAbstract): TcpNetClient
---@field get_CurrentlyReceivingBytes fun(): number
---@field Start fun(): nil
---@field Dispose fun(): nil
---@field Connect fun(host: string, port: number, OnConnectionResult: any`1, OnDisconnected: any`1): NetConnection
