---@meta PlayerEventDelegate
---@class PlayerEventDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): PlayerEventDelegate
---@field Invoke fun(byPlayer: IClientPlayer): nil
---@field BeginInvoke fun(byPlayer: IClientPlayer, callback: AsyncCallback, object: table): IAsyncResult
