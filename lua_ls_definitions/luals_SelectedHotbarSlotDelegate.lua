---@meta SelectedHotbarSlotDelegate
---@class SelectedHotbarSlotDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): SelectedHotbarSlotDelegate
---@field Invoke fun(byPlayer: IServerPlayer): nil
---@field BeginInvoke fun(byPlayer: IServerPlayer, callback: AsyncCallback, object: table): IAsyncResult
