---@meta ServerSystemHeartbeat
---@class ServerSystemHeartbeat: ServerSystem
---@field ctor fun(server: ServerMain): ServerSystemHeartbeat
...
---@field SendHeartbeat fun(): nil
---@field SendUnregister fun(): nil
