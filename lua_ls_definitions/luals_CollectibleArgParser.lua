---@meta CollectibleArgParser
---@class CollectibleArgParser: ArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, itemclass: EnumItemClass, isMandatoryArg: boolean): CollectibleArgParser
