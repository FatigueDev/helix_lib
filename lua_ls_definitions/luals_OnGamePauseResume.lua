---@meta OnGamePauseResume
---@class OnGamePauseResume: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): OnGamePauseResume
---@field Invoke fun(isPaused: boolean): nil
---@field BeginInvoke fun(isPaused: boolean, callback: AsyncCallback, object: table): IAsyncResult
