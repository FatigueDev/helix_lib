---@meta PlotDelegate3DBlockPos
---@class PlotDelegate3DBlockPos: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): PlotDelegate3DBlockPos
---@field Invoke fun(pos: BlockPos): nil
---@field BeginInvoke fun(pos: BlockPos, callback: AsyncCallback, object: table): IAsyncResult
