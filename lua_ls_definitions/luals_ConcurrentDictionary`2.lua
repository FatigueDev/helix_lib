---@meta ConcurrentDictionary`2
---@class ConcurrentDictionary`2: Object
---@field ctor fun(): ConcurrentDictionary`2
---@overload fun(concurrencyLevel: number, capacity: number): ConcurrentDictionary`2
---@overload fun(collection: any[]): ConcurrentDictionary`2
---@overload fun(comparer: IEqualityComparer`1): ConcurrentDictionary`2
---@overload fun(collection: any[], comparer: IEqualityComparer`1): ConcurrentDictionary`2
---@overload fun(concurrencyLevel: number, collection: any[], comparer: IEqualityComparer`1): ConcurrentDictionary`2
---@overload fun(concurrencyLevel: number, capacity: number, comparer: IEqualityComparer`1): ConcurrentDictionary`2
...
---@field Item TValue
---@field Comparer TValue
---@field Count TValue
---@field IsEmpty TValue
---@field Keys TValue
---@field Values TValue
