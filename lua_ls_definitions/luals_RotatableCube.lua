---@meta RotatableCube
---@class RotatableCube: Cuboidf
---@field ctor fun(): RotatableCube
---@overload fun(MinX: Single, MinY: Single, MinZ: Single, MaxX: Single, MaxY: Single, MaxZ: Single): RotatableCube
---@field ToHitboxCuboidi fun(rotateY: Single, origin: Vec3d): Cuboidi
---@field RotatedCopy fun(): Cuboidf
---@field Clone fun(): RotatableCube
...
---@field Startd Single
---@field Endd Single
---@field RotateX Single
---@field RotateY Single
---@field RotateZ Single
---@field Origin Single
---@field X1 Single
---@field Y1 Single
---@field Z1 Single
