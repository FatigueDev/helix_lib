---@meta ItemstackTextComponent
---@class ItemstackTextComponent: ItemstackComponentBase
---@field ctor fun(capi: ICoreClientAPI, itemstack: ItemStack, size: Double, rightSidePadding: Double, floatType: EnumFloat, onStackClicked: any`1): ItemstackTextComponent
