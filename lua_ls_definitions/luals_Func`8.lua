---@meta Func`8
---@class Func`8: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): Func`8
---@field Invoke fun(t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7): TResult
---@field BeginInvoke fun(t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, callback: AsyncCallback, object: table): IAsyncResult
