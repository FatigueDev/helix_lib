---@meta GuiElementDialogBackground
---@class GuiElementDialogBackground: GuiElement
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, withTitlebar: boolean, strokeWidth: Double, alpha: Single): GuiElementDialogBackground
...
---@field Shade ElementBounds
---@field Alpha ElementBounds
---@field FullBlur ElementBounds
