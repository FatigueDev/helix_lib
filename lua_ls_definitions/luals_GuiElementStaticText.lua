---@meta GuiElementStaticText
---@class GuiElementStaticText: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, text: string, orientation: EnumTextOrientation, bounds: ElementBounds, font: CairoFont): GuiElementStaticText
---@field GetTextHeight fun(): Double
---@field ComposeTextElements fun(ctx: Context, surface: ImageSurface): nil
---@field AutoBoxSize fun(onlyGrow: boolean): nil
---@field SetValue fun(text: string): nil
---@field AutoFontSize fun(onlyShrink: boolean): nil
