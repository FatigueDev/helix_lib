---@meta PlayerPacketMonitor
---@class PlayerPacketMonitor: ServerSystem
---@field ctor fun(server: ServerMain): PlayerPacketMonitor
---@field GetUpdateInterval fun(): number
---@field RemoveMonitorClient fun(clientid: number): boolean
---@field OnServerTick fun(dt: Single): nil
---@field CheckPacket fun(clientId: number, packet: Packet_Client): boolean
---@field SaveConfig fun(): nil
