---@meta GuiDialogTransformEditor
---@class GuiDialogTransformEditor: GuiDialog
---@field ctor fun(capi: ICoreClientAPI): GuiDialogTransformEditor
---@field get_TargetTransform fun(): ModelTransform
---@field set_TargetTransform fun(value: ModelTransform): nil
...
---@field ToggleKeyCombinationCode ModelTransform
---@field PrefersUngrabbedMouse ModelTransform
---@field SingleComposer ModelTransform
---@field DebugName ModelTransform
---@field ZSize ModelTransform
---@field Focused ModelTransform
---@field Focusable ModelTransform
---@field DialogType ModelTransform
---@field DrawOrder ModelTransform
---@field InputOrder ModelTransform
---@field UnregisterOnClose ModelTransform
---@field DisableMouseGrab ModelTransform
---@field OnOpened ModelTransform
---@field OnClosed ModelTransform
---@field extraTransforms ModelTransform
---@field Composers ModelTransform
---@field ignoreNextKeyPress ModelTransform
---@field MouseOverCursor ModelTransform
