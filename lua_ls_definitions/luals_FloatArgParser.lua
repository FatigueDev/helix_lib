---@meta FloatArgParser
---@class FloatArgParser: ArgumentParserBase
---@field ctor fun(argName: string, min: Single, max: Single, isMandatoryArg: boolean): FloatArgParser
---@overload fun(argName: string, isMandatoryArg: boolean): FloatArgParser
---@overload fun(argName: string, defaultvalue: Single, isMandatoryArg: boolean): FloatArgParser
