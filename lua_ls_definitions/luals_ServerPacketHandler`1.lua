---@meta ServerPacketHandler`1
---@class ServerPacketHandler`1: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): ServerPacketHandler`1
---@field Invoke fun(packet: Packet_Server): nil
---@field BeginInvoke fun(packet: Packet_Server, callback: AsyncCallback, object: table): IAsyncResult
