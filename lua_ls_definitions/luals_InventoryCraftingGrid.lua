---@meta InventoryCraftingGrid
---@class InventoryCraftingGrid: InventoryBasePlayer
---@field ctor fun(inventoryID: string, api: ICoreAPI): InventoryCraftingGrid
---@overload fun(className: string, instanceID: string, api: ICoreAPI): InventoryCraftingGrid
---@field LateInitialize fun(inventoryID: string, api: ICoreAPI): nil
---@field CanStillCraftCurrent fun(): boolean
