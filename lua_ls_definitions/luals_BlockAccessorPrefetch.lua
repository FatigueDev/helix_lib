---@meta BlockAccessorPrefetch
---@class BlockAccessorPrefetch: BlockAccessorRelaxed
---@field ctor fun(worldmap: WorldMap, worldAccessor: IWorldAccessor, synchronize: boolean, relight: boolean): BlockAccessorPrefetch
---@field PrefetchBlocks fun(minPos: BlockPos, maxPos: BlockPos): nil
---@field WalkBlocks fun(minPos: BlockPos, maxPos: BlockPos, onBlock: Action`4): nil
...
---@overload fun(minPos: BlockPos, maxPos: BlockPos, onBlock: Action`4, centerOrder: boolean): nil
