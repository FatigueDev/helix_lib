---@meta ClientSystemStartup
---@class ClientSystemStartup: ClientSystem
---@field ctor fun(game: ClientMain): ClientSystemStartup
---@field StartLoadingBlockShapesWhenReady fun(): nil
---@field StartLoadingItemShapesWhenReady fun(): nil
---@field StartLoadingEntityShapesWhenReady fun(): nil
---@field StartSlowLoadingSoundsWhenReady fun(): nil
...
---@field Name string
---@field loadSoundsSlowPrerequisites string
