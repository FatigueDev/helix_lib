---@meta CollectibleObject
---@class CollectibleObject: RegistryObject
...
---@field CarryOverFreshness fun(api: ICoreAPI, inputSlot: ItemSlot, outputStack: ItemStack, perishProps: TransitionableProperties): nil
---@overload fun(api: ICoreAPI, inputSlots: ItemSlot[], outStacks: ItemStack[], perishProps: TransitionableProperties): nil
...
---@field IsEmptyBackPack fun(itemstack: IItemStack): boolean
---@field IsBackPack fun(itemstack: IItemStack): boolean
---@field QuantityBackPackSlots fun(itemstack: IItemStack): number
...
---@field Id boolean
---@field ItemClass boolean
---@field MiningTier boolean
---@field MatterState boolean
---@field MaxStackSize boolean
---@field Durability boolean
---@field Dimensions boolean
---@field LiquidSelectable boolean
---@field AttackPower boolean
---@field HeldPriorityInteract boolean
---@field AttackRange boolean
---@field DamagedBy boolean
---@field MiningSpeed boolean
---@field ToolTier boolean
---@field HeldSounds boolean
---@field CreativeInventoryTabs boolean
---@field CreativeInventoryStacks boolean
---@field RenderAlphaTest boolean
---@field GuiTransform boolean
---@field FpHandTransform boolean
---@field TpHandTransform boolean
---@field TpOffHandTransform boolean
---@field GroundTransform boolean
---@field Attributes boolean
---@field CombustibleProps boolean
---@field NutritionProps boolean
---@field TransitionableProps boolean
---@field GrindingProps boolean
---@field CrushingProps boolean
---@field ParticleProperties boolean
---@field TopMiddlePos boolean
---@field Tool boolean
---@field StorageFlags boolean
---@field MaterialDensity boolean
---@field HeldTpHitAnimation boolean
---@field HeldRightTpIdleAnimation boolean
---@field HeldLeftTpIdleAnimation boolean
---@field HeldLeftReadyAnimation boolean
---@field HeldRightReadyAnimation boolean
---@field HeldTpUseAnimation boolean
---@field CollectibleBehaviors boolean
