---@meta ClientPlayerInventoryManager
---@class ClientPlayerInventoryManager: PlayerInventoryManager
---@field ctor fun(AllInventories: Orderedtable<any, any>, player: IPlayer, game: ClientMain): ClientPlayerInventoryManager
...
---@field SetActiveHotbarSlotNumberFromServer fun(slotid: number): nil
