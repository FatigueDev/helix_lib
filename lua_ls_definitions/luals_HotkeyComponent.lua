---@meta HotkeyComponent
---@class HotkeyComponent: RichTextComponent
---@field ctor fun(api: ICoreClientAPI, hotkeycode: string, font: CairoFont): HotkeyComponent
---@field ComposeElements fun(ctx: Context, surfaceUnused: ImageSurface): nil
---@field GenHotkeyTexture fun(): nil
...
---@field DrawHotkey fun(capi: ICoreClientAPI, keycode: string, x: Double, y: Double, ctx: Context, font: CairoFont, lineheight: Double, textHeight: Double, pluswdith: Double, symbolspacing: Double, leftRightPadding: Double, color: Double[]): Double
