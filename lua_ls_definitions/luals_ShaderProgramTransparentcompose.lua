---@meta ShaderProgramTransparentcompose
---@class ShaderProgramTransparentcompose: ShaderProgram
---@field ctor fun(): ShaderProgramTransparentcompose
---@field set_Accumulation2D fun(value: number): nil
---@field set_Revealage2D fun(value: number): nil
---@field set_InGlow2D fun(value: number): nil
