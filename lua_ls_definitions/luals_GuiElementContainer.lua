---@meta GuiElementContainer
---@class GuiElementContainer: GuiElement
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds): GuiElementContainer
...
---@field Add fun(elem: GuiElement, afterPosition: number): nil
---@field RemoveCell fun(position: number): nil
