---@meta GuiElementCustomDraw
---@class GuiElementCustomDraw: GuiElement
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, OnDraw: DrawDelegateWithBounds, interactive: boolean): GuiElementCustomDraw
