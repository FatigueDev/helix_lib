---@meta GuiScreenDisconnected
---@class GuiScreenDisconnected: GuiScreen
---@field ctor fun(reason: string, screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenDisconnected
