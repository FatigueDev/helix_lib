---@meta WaterSplashParticles
---@class WaterSplashParticles: ParticlesProviderBase
---@field ctor fun(): WaterSplashParticles
...
---@field AddPos boolean
---@field AddVelocity boolean
---@field QuantityMul boolean
