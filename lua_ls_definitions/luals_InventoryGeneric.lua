---@meta InventoryGeneric
---@class InventoryGeneric: InventoryBase
---@field ctor fun(quantitySlots: number, className: string, instanceId: string, api: ICoreAPI, onNewSlot: NewSlotDelegate): InventoryGeneric
---@overload fun(quantitySlots: number, invId: string, api: ICoreAPI, onNewSlot: NewSlotDelegate): InventoryGeneric
