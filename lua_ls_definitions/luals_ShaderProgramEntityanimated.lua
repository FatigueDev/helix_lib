---@meta ShaderProgramEntityanimated
---@class ShaderProgramEntityanimated: ShaderProgram
---@field ctor fun(): ShaderProgramEntityanimated
---@field set_EntityTex2D fun(value: number): nil
---@field set_AlphaTest fun(value: Single): nil
---@field set_GlitchEffectStrength fun(value: Single): nil
---@field set_EntityId fun(value: number): nil
---@field set_GlitchFlicker fun(value: number): nil
---@field set_DepthOffset fun(value: Single): nil
...
---@field set_FrostAlpha fun(value: Single): nil
...
---@field set_SkipRenderJointId fun(value: number): nil
---@field set_SkipRenderJointId2 fun(value: number): nil
---@field set_ElementTransforms fun(value: Single[]): nil
