---@meta SelectionChangedDelegate
---@class SelectionChangedDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): SelectionChangedDelegate
---@field Invoke fun(code: string, selected: boolean): nil
---@field BeginInvoke fun(code: string, selected: boolean, callback: AsyncCallback, object: table): IAsyncResult
