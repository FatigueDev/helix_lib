---@meta GuiElementItemSlotGridExcl
---@class GuiElementItemSlotGridExcl: GuiElementItemSlotGridBase
---@field ctor fun(capi: ICoreClientAPI, inventory: IInventory, sendPacketHandler: any`1, columns: number, excludingSlots: number[], bounds: ElementBounds): GuiElementItemSlotGridExcl
