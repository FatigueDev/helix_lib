---@meta ShaderProgramParticlesquad2d
---@class ShaderProgramParticlesquad2d: ShaderProgram
---@field ctor fun(): ShaderProgramParticlesquad2d
---@field set_ParticleTex2D fun(value: number): nil
---@field set_OitPass fun(value: number): nil
---@field set_WithTexture fun(value: number): nil
---@field set_HeldItemMode fun(value: number): nil
