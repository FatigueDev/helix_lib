---@meta NetworkServerMessageHandler`1
---@class NetworkServerMessageHandler`1: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): NetworkServerMessageHandler`1
---@field Invoke fun(packet: T): nil
---@field BeginInvoke fun(packet: T, callback: AsyncCallback, object: table): IAsyncResult
