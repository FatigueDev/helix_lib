---@meta PrivilegeArgParser
---@class PrivilegeArgParser: ArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, isMandatoryArg: boolean): PrivilegeArgParser
