---@meta WindowResizedDelegate
---@class WindowResizedDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): WindowResizedDelegate
---@field Invoke fun(nowWidth: number, nowHeight: number): nil
---@field BeginInvoke fun(nowWidth: number, nowHeight: number, callback: AsyncCallback, object: table): IAsyncResult
