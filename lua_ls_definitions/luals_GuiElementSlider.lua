---@meta GuiElementSlider
---@class GuiElementSlider: GuiElementControl
---@field ctor fun(capi: ICoreClientAPI, onNewSliderValue: ActionConsumable`1, bounds: ElementBounds): GuiElementSlider
...
---@field SetAlarmValue fun(value: number): nil
---@field SetValues fun(currentValue: number, minValue: number, maxValue: number, step: number, unit: string): nil
---@field SetValue fun(currentValue: number): nil
