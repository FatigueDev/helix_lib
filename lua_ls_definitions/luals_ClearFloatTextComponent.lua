---@meta ClearFloatTextComponent
---@class ClearFloatTextComponent: RichTextComponent
---@field ctor fun(api: ICoreClientAPI, unScaleMarginTop: Single): ClearFloatTextComponent
