---@meta GuiScreenMessage
---@class GuiScreenMessage: GuiScreen
---@field ctor fun(title: string, text: string, OnPressBack: Action, screenManager: ScreenManager, parentScreen: GuiScreen): GuiScreenMessage
