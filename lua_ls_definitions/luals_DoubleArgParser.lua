---@meta DoubleArgParser
---@class DoubleArgParser: ArgumentParserBase
---@field ctor fun(argName: string, min: Double, max: Double, isMandatoryArg: boolean): DoubleArgParser
---@overload fun(argName: string, defaultvalue: Double, isMandatoryArg: boolean): DoubleArgParser
