---@meta UpnpCompleteDelegate
---@class UpnpCompleteDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): UpnpCompleteDelegate
---@field Invoke fun(success: boolean): nil
---@field BeginInvoke fun(success: boolean, callback: AsyncCallback, object: table): IAsyncResult
