---@meta BlockAccessorRelaxed
---@class BlockAccessorRelaxed: BlockAccessorBase
---@field ctor fun(worldmap: WorldMap, worldAccessor: IWorldAccessor, synchronize: boolean, relight: boolean): BlockAccessorRelaxed
