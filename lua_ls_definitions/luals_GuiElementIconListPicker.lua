---@meta GuiElementIconListPicker
---@class GuiElementIconListPicker: GuiElementElementListPickerBase`1
---@field ctor fun(capi: ICoreClientAPI, elem: string, bounds: ElementBounds): GuiElementIconListPicker
---@field DrawElement fun(icon: string, ctx: Context, surface: ImageSurface): nil
