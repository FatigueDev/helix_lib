---@meta GuiElementNumberInput
---@class GuiElementNumberInput: GuiElementTextInput
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, OnTextChanged: any`1, font: CairoFont): GuiElementNumberInput
...
---@field HideCharacters fun(): nil
---@field SetPlaceHolderText fun(text: string): nil
...
---@field buttonHighlightTexture number
