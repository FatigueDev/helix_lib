---@meta ShaderProgramDebugdepthbuffer
---@class ShaderProgramDebugdepthbuffer: ShaderProgram
---@field ctor fun(): ShaderProgramDebugdepthbuffer
---@field set_DepthSampler2D fun(value: number): nil
