---@meta EntityTypeArgParser
---@class EntityTypeArgParser: ArgumentParserBase
---@field ctor fun(argName: string, api: ICoreAPI, isMandatoryArg: boolean): EntityTypeArgParser
