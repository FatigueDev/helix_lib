...
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds): GuiElement
...
---@field scaledi fun(value: Double): number
---@field getPattern fun(bitmap: SKBitmap): SurfacePattern
---@overload fun(bitmap: BitmapExternal): SurfacePattern
---@field getImageSurfaceFromAsset fun(bitmap: SKBitmap): ImageSurface
---@overload fun(bitmap: BitmapExternal): ImageSurface
---@overload fun(bitmap: SKBitmap, width: number, height: number): ImageSurface
---@overload fun(bitmap: BitmapExternal, width: number, height: number): ImageSurface
---@field BeforeCalcBounds fun(): nil
---@field getPattern fun(capi: ICoreClientAPI, textureLoc: AssetLocation, doCache: boolean, mulAlpha: number, scale: Single): SurfacePattern
---@overload fun(capi: ICoreClientAPI, textureLoc: AssetLocation, mulAlpha: number): ImageSurface
---@field fillWithPattern fun(capi: ICoreClientAPI, ctx: Context, textureLoc: AssetLocation, nearestScalingFiler: boolean, preserve: boolean, mulAlpha: number, scale: Single): SurfacePattern
---@field DiscardPattern fun(textureLoc: AssetLocation): nil
---@field Rectangle fun(ctx: Context, bounds: ElementBounds): nil
---@overload fun(ctx: Context, x: Double, y: Double, width: Double, height: Double): nil
...
---@field RoundRectangle fun(ctx: Context, x: Double, y: Double, width: Double, height: Double, radius: Double): nil
...
---@field dirtTextureName ElementBounds
---@field noisyMetalTextureName ElementBounds
---@field woodTextureName ElementBounds
---@field stoneTextureName ElementBounds
---@field waterTextureName ElementBounds
---@field paperTextureName ElementBounds
GuiElement = {}
