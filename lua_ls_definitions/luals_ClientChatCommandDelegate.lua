---@meta ClientChatCommandDelegate
---@class ClientChatCommandDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): ClientChatCommandDelegate
---@field Invoke fun(groupId: number, args: CmdArgs): nil
---@field BeginInvoke fun(groupId: number, args: CmdArgs, callback: AsyncCallback, object: table): IAsyncResult
