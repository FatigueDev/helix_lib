---@meta PlotDelegate2D
---@class PlotDelegate2D: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): PlotDelegate2D
---@field Invoke fun(x: number, z: number): nil
---@field BeginInvoke fun(x: number, z: number, callback: AsyncCallback, object: table): IAsyncResult
