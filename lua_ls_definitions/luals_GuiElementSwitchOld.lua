---@meta GuiElementSwitchOld
---@class GuiElementSwitchOld: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, OnToggled: any`1, bounds: ElementBounds): GuiElementSwitchOld
