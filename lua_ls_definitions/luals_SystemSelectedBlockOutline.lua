---@meta SystemSelectedBlockOutline
---@class SystemSelectedBlockOutline: ClientSystem
---@field ctor fun(game: ClientMain): SystemSelectedBlockOutline
---@field get_Name fun(): string
---@field Dispose fun(game: ClientMain): nil
---@field OnRenderFrame3DPost fun(deltaTime: Single): nil
