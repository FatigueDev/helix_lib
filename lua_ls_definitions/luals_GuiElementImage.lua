---@meta GuiElementImage
---@class GuiElementImage: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, imageAsset: AssetLocation): GuiElementImage
---@field ComposeElements fun(context: Context, surface: ImageSurface): nil
