---@meta SyncedEntityPos
---@class SyncedEntityPos: EntityPos
---@field ctor fun(): SyncedEntityPos
---@overload fun(position: Vec3d): SyncedEntityPos
---@overload fun(x: Double, y: Double, z: Double, heading: Single, pitch: Single): SyncedEntityPos
...
---@field set_XInternal fun(value: Double): nil
---@field set_YInternal fun(value: Double): nil
---@field set_ZInternal fun(value: Double): nil
---@field set_RollInternal fun(value: Single): nil
---@field set_YawInternal fun(value: Single): nil
---@field set_PitchInternal fun(value: Single): nil
---@field set_StanceInternal fun(value: number): nil
...
---@field Yaw Double
---@field Pitch Double
---@field XInternal Double
---@field YInternal Double
---@field ZInternal Double
---@field RollInternal Double
---@field YawInternal Double
---@field PitchInternal Double
---@field StanceInternal Double
---@field Dirty Double
...
---@field LastReceivedClientPosition Double
