---@meta SystemRenderInsideBlock
---@class SystemRenderInsideBlock: ClientSystem
---@field ctor fun(game: ClientMain): SystemRenderInsideBlock
...
---@field Name string
---@field lightExt string
---@field blockExt string
