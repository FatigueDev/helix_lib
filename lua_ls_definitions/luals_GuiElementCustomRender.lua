---@meta GuiElementCustomRender
---@class GuiElementCustomRender: GuiElement
---@field ctor fun(capi: ICoreClientAPI, bounds: ElementBounds, onRender: RenderDelegateWithBounds): GuiElementCustomRender
