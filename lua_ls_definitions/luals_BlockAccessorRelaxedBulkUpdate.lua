---@meta BlockAccessorRelaxedBulkUpdate
---@class BlockAccessorRelaxedBulkUpdate: BlockAccessorBase
---@field ctor fun(worldmap: WorldMap, worldAccessor: IWorldAccessor, synchronize: boolean, relight: boolean, debug: boolean): BlockAccessorRelaxedBulkUpdate
