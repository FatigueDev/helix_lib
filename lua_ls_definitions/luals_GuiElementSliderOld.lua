---@meta GuiElementSliderOld
---@class GuiElementSliderOld: GuiElement
---@field ctor fun(capi: ICoreClientAPI, onNewSliderValue: ActionConsumable`1, bounds: ElementBounds): GuiElementSliderOld
