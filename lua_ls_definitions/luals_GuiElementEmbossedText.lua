---@meta GuiElementEmbossedText
---@class GuiElementEmbossedText: GuiElementTextBase
---@field ctor fun(capi: ICoreClientAPI, text: string, font: CairoFont, bounds: ElementBounds): GuiElementEmbossedText
---@field IsEnabled fun(): boolean
---@field SetEnabled fun(enabled: boolean): nil
