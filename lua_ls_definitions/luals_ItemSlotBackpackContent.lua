---@meta ItemSlotBackpackContent
---@class ItemSlotBackpackContent: ItemSlotSurvival
---@field ctor fun(inventory: InventoryBase, BackpackIndex: number, SlotIndex: number, storageType: EnumItemStorageFlags): ItemSlotBackpackContent
...
---@field BackpackIndex EnumItemStorageFlags
---@field SlotIndex EnumItemStorageFlags
---@field storageType EnumItemStorageFlags
