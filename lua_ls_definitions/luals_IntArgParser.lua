---@meta IntArgParser
---@class IntArgParser: ArgumentParserBase
---@field ctor fun(argName: string, min: number, max: number, defaultValue: number, isMandatoryArg: boolean): IntArgParser
---@overload fun(argName: string, defaultValue: number, isMandatoryArg: boolean): IntArgParser
