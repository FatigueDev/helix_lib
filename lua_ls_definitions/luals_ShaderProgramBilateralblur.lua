---@meta ShaderProgramBilateralblur
---@class ShaderProgramBilateralblur: ShaderProgram
---@field ctor fun(): ShaderProgramBilateralblur
---@field set_InputTexture2D fun(value: number): nil
---@field set_DepthTexture2D fun(value: number): nil
---@field set_FrameSize fun(value: Vec2f): nil
---@field set_IsVertical fun(value: number): nil
