---@meta SlideshowGridRecipeTextComponent
---@class SlideshowGridRecipeTextComponent: ItemstackComponentBase
---@field ctor fun(capi: ICoreClientAPI, gridrecipes: GridRecipe[], size: Double, floatType: EnumFloat, onStackClicked: any`1, allStacks: ItemStack[]): SlideshowGridRecipeTextComponent
...
---@field GridRecipesAndUnIn string
---@field CurrentVisibleRecipe string
---@field offY string
---@field offX string
