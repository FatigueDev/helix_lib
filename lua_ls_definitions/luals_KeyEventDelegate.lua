---@meta KeyEventDelegate
---@class KeyEventDelegate: MulticastDelegate
---@field ctor fun(object: table, method: IntPtr): KeyEventDelegate
---@field Invoke fun(e: KeyEvent): nil
---@field BeginInvoke fun(e: KeyEvent, callback: AsyncCallback, object: table): IAsyncResult
