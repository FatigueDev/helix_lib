---@meta SystemRenderSunMoon
---@class SystemRenderSunMoon: ClientSystem
---@field ctor fun(game: ClientMain): SystemRenderSunMoon
---@field get_Name fun(): string
---@field OnRenderFrame3D fun(dt: Single): nil
---@field prepareSunMat fun(): nil
---@field CreateLookRotation fun(direction: Vector3): Quaternion
...
---@field Name string
---@field ModelMat string
---@field sunScale string
---@field moonScale string
SystemRenderSunMoon = {}
