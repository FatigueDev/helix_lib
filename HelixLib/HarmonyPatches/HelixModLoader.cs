...
// {
//     public class HelixModLoader : Vintagestory.Common.ModLoader
//     {
...
//         public HelixModLoader(ILogger logger, EnumAppSide side, IEnumerable<string> modSearchPaths, bool traceLog)
//             : this(null, side, logger, modSearchPaths, traceLog)
//         {
//         }

//         public HelixModLoader(ICoreAPI api, IEnumerable<string> modSearchPaths, bool traceLog)
//             : this(api, api.Side, api.World.Logger, modSearchPaths, traceLog)
//         {
//         }

//         public HelixModLoader(ICoreAPI api, EnumAppSide side, ILogger logger, IEnumerable<string> modSearchPaths, bool traceLog)
//         {
//             this.api = api;
//             this.side = side;
//             this.logger = logger;
...
//                     FolderOrigin origin = (num ? new ThemeFolderOrigin(mod2.FolderPath) : new FolderOrigin(mod2.FolderPath));
...
//                     }
//                     else if (dependingMod.Error == ModError.Dependency)
//                     {
...
//                 {
//                     if (system4 != null && system4.ShouldLoad(side) && !TryRunModPhase(system4.Mod, system4, api, phase))
//                     {
//                         logger.Error("Failed to run mod phase {0} for mod {1}", phase, system4);
//                     }
//                 }
//                 return;
//             }
//             List<ModSystem> startedSystems = new List<ModSystem>();
//             foreach (ModSystem system3 in enabledSystems)
//             {
//                 if (system3.ShouldLoad(side))
//                 {
//                     logger.VerboseDebug("Starting system: " + system3.GetType().Name);
//                     if (TryRunModPhase(system3.Mod, system3, api, ModRunPhase.Normal))
//                     {
//                         startedSystems.Add(system3);
//                         continue;
//                     }
//                     logger.Error("Failed to start system {0}", system3);
//                 }
//             }
...
//                 foreach (ModSystem system2 in group)
//                 {
//                     logger.Notification("        {0}", system2);
//                 }
//             }
