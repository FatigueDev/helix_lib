...
---@class HudElementBlockAndEntityInfo: HudElement, IDisposable, GuiDialog, HudElement
...
---@return HudElementBlockAndEntityInfo
function HudElementBlockAndEntityInfo.ctor(capi) end

---@return string
function HudElementBlockAndEntityInfo.get_ToggleKeyCombinationCode() end

---@return boolean
function HudElementBlockAndEntityInfo.ShouldReceiveRenderEvents() end

function HudElementBlockAndEntityInfo.OnGuiOpened() end

function HudElementBlockAndEntityInfo.OnGuiClosed() end

function HudElementBlockAndEntityInfo.Dispose() end

---@return EnumDialogType
function HudElementBlockAndEntityInfo.get_DialogType() end

---@return boolean
function HudElementBlockAndEntityInfo.get_PrefersUngrabbedMouse() end

---@param deltaTime number
function HudElementBlockAndEntityInfo.OnRenderGUI(deltaTime) end
...
function HudElementBlockAndEntityInfo.get_SingleComposer() end
...
function HudElementBlockAndEntityInfo.set_SingleComposer(value) end

---@return string
function HudElementBlockAndEntityInfo.get_DebugName() end

---@return number
function HudElementBlockAndEntityInfo.get_ZSize() end

---@return boolean
function HudElementBlockAndEntityInfo.get_Focused() end

---@return boolean
function HudElementBlockAndEntityInfo.get_Focusable() end

---@param value function
function HudElementBlockAndEntityInfo.add_OnOpened(value) end

---@param value function
function HudElementBlockAndEntityInfo.remove_OnOpened(value) end

---@param value function
function HudElementBlockAndEntityInfo.add_OnClosed(value) end

---@param value function
function HudElementBlockAndEntityInfo.remove_OnClosed(value) end

-- Makes this gui pop up once a pre-set given key combination is set.
function HudElementBlockAndEntityInfo.OnBlockTexturesLoaded() end

function HudElementBlockAndEntityInfo.OnLevelFinalize() end

function HudElementBlockAndEntityInfo.OnOwnPlayerDataReceived() end

---@return number
function HudElementBlockAndEntityInfo.get_DrawOrder() end

---@return number
function HudElementBlockAndEntityInfo.get_InputOrder() end

---@return boolean
function HudElementBlockAndEntityInfo.get_UnregisterOnClose() end

-- Attempts to open this dialogue.
---@return boolean
function HudElementBlockAndEntityInfo.TryOpen() end

---@param withFocus boolean
---@return boolean
function HudElementBlockAndEntityInfo.TryOpen(withFocus) end

-- Attempts to close this dialogue- triggering the OnCloseDialogue event.
---@return boolean
function HudElementBlockAndEntityInfo.TryClose() end

-- Unfocuses the dialogue.
function HudElementBlockAndEntityInfo.UnFocus() end

-- Focuses the dialog
function HudElementBlockAndEntityInfo.Focus() end

-- If the dialogue is opened, this attempts to close it.  If the dialogue is closed, this attempts to open it.
function HudElementBlockAndEntityInfo.Toggle() end

-- Is this dialogue opened?
---@return boolean
function HudElementBlockAndEntityInfo.IsOpened() end

-- Is this dialogue opened in the given context?
---@param dialogComposerName string
---@return boolean
function HudElementBlockAndEntityInfo.IsOpened(dialogComposerName) end

-- This runs before the render.  Local update method.
---@param deltaTime number
function HudElementBlockAndEntityInfo.OnBeforeRenderFrame3D(deltaTime) end

-- This runs when the dialogue is finalizing and cleaning up all of the components.
---@param dt number
function HudElementBlockAndEntityInfo.OnFinalizeFrame(dt) end

-- Fires when keys are held down.
---@param args KeyEvent
function HudElementBlockAndEntityInfo.OnKeyDown(args) end

-- Fires when the keys are pressed.
---@param args KeyEvent
function HudElementBlockAndEntityInfo.OnKeyPress(args) end

-- Fires when the keys are released.
---@param args KeyEvent
function HudElementBlockAndEntityInfo.OnKeyUp(args) end

-- Fires explicitly when the Escape key is pressed and attempts to close the dialogue.
---@return boolean
function HudElementBlockAndEntityInfo.OnEscapePressed() end

-- Fires when the mouse enters the given slot.
---@param slot ItemSlot The default item slot to item stacks
---@return boolean
function HudElementBlockAndEntityInfo.OnMouseEnterSlot(slot) end

-- Fires when the mouse leaves the slot.
---@param itemSlot ItemSlot The default item slot to item stacks
---@return boolean
function HudElementBlockAndEntityInfo.OnMouseLeaveSlot(itemSlot) end

-- Fires when the mouse clicks within the slot.
---@param itemSlot ItemSlot The default item slot to item stacks
---@return boolean
function HudElementBlockAndEntityInfo.OnMouseClickSlot(itemSlot) end

-- Fires when a mouse button is held down.
---@param args MouseEvent This contains the data for what the mouse is currently doing.
function HudElementBlockAndEntityInfo.OnMouseDown(args) end

-- Fires when a mouse button is released.
---@param args MouseEvent This contains the data for what the mouse is currently doing.
function HudElementBlockAndEntityInfo.OnMouseUp(args) end

-- Fires when the mouse is moved.
---@param args MouseEvent This contains the data for what the mouse is currently doing.
function HudElementBlockAndEntityInfo.OnMouseMove(args) end

-- Fires when the mouse wheel is scrolled.
---@param args MouseWheelEventArgs The event arguments for the mouse.
function HudElementBlockAndEntityInfo.OnMouseWheel(args) end

-- A check for whether the dialogue should recieve keyboard events.
---@return boolean
function HudElementBlockAndEntityInfo.ShouldReceiveKeyboardEvents() end

-- A check if the dialogue should recieve mouse events.
---@return boolean
function HudElementBlockAndEntityInfo.ShouldReceiveMouseEvents() end

---@return boolean
function HudElementBlockAndEntityInfo.RequiresUngrabbedMouse() end

---@return boolean
function HudElementBlockAndEntityInfo.get_DisableMouseGrab() end

-- Should this dialog (e.g. textbox) capture all the keyboard events except for escape.
---@return boolean
function HudElementBlockAndEntityInfo.CaptureAllInputs() end
...
---@return boolean
function HudElementBlockAndEntityInfo.CaptureRawMouse() end

-- Clears the composers.
function HudElementBlockAndEntityInfo.ClearComposers() end

-- Checks if the player is in range (pickingrange) of the given position
---@param pos Vec3d Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
---@return boolean
function HudElementBlockAndEntityInfo.IsInRangeOf(pos) end

---@return userdata
function HudElementBlockAndEntityInfo.GetType() end

---@return string
function HudElementBlockAndEntityInfo.ToString() end

---@param obj userdata
---@return boolean
function HudElementBlockAndEntityInfo.Equals(obj) end

---@return number
function HudElementBlockAndEntityInfo.GetHashCode() end
