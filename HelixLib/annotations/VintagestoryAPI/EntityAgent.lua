...
---@class EntityAgent: Entity, RegistryObject, Entity
...
---@field EntityServerPacketId nil
---@field EntityClientPacketId nil
EntityAgent = {}

---@return EntityAgent
function EntityAgent.ctor() end

---@return boolean
function EntityAgent.get_IsCreature() end

---@return number
function EntityAgent.get_BodyYaw() end

---@param value number
function EntityAgent.set_BodyYaw(value) end

---@return number
function EntityAgent.get_BodyYawServer() end

---@param value number
function EntityAgent.set_BodyYawServer(value) end

---@return number
function EntityAgent.get_HerdId() end

---@param value number
function EntityAgent.set_HerdId(value) end

---@return IMountable
function EntityAgent.get_MountedOn() end

---@return ItemSlot # The default item slot to item stacks
function EntityAgent.get_LeftHandItemSlot() end

---@param value ItemSlot The default item slot to item stacks
function EntityAgent.set_LeftHandItemSlot(value) end

---@return ItemSlot # The default item slot to item stacks
function EntityAgent.get_RightHandItemSlot() end

---@param value ItemSlot The default item slot to item stacks
function EntityAgent.set_RightHandItemSlot(value) end

---@return ItemSlot # The default item slot to item stacks
function EntityAgent.get_ActiveHandItemSlot() end

---@return IInventory # Basic interface representing an item inventory
function EntityAgent.get_GearInventory() end

---@param value IInventory Basic interface representing an item inventory
function EntityAgent.set_GearInventory(value) end

---@return boolean
function EntityAgent.get_ShouldDespawn() end

---@param properties EntityProperties
---@param api ICoreAPI Common API Components that are available on the server and the client. Cast to ICoreServerAPI or ICoreClientAPI to access side specific features.
---@param InChunkIndex3d number
function EntityAgent.Initialize(properties, api, InChunkIndex3d) end

---@return EntityControls # The available controls to move around a character in a game world
function EntityAgent.get_Controls() end

---@return EntityControls # The available controls to move around a character in a game world
function EntityAgent.get_ServerControls() end

-- Are the eyes of this entity submerged in liquid?
---@return boolean
function EntityAgent.IsEyesSubmerged() end

-- Attempts to mount the player on a target.
---@param onmount IMountable
---@return boolean
function EntityAgent.TryMount(onmount) end

-- Attempts to un-mount the player.
---@return boolean
function EntityAgent.TryUnmount() end

---@param reason? EnumDespawnReason
---@param damageSourceForDeath? DamageSource
function EntityAgent.Die(reason, damageSourceForDeath) end
...
function EntityAgent.OnNoPath(target) end
...
function EntityAgent.OnInteract(byEntity, slot, hitPosition, mode) end
...
function EntityAgent.DidAttack(source, targetEntity) end

---@param damageSource DamageSource
---@param damage number
---@return boolean
function EntityAgent.ShouldReceiveDamage(damageSource, damage) end

---@param damageSource DamageSource
---@param damage number
---@return boolean
function EntityAgent.ReceiveDamage(damageSource, damage) end
...
function EntityAgent.ReceiveSaturation(saturation, foodCat, saturationLossDelay, nutritionGainMultiplier) end
...
---@param nutritionGainMultiplier? number
---@return boolean
function EntityAgent.ShouldReceiveSaturation(saturation, foodCat, saturationLossDelay, nutritionGainMultiplier) end

---@param dt number
function EntityAgent.OnGameTick(dt) end

-- Gets the walk speed multiplier.
---@param groundDragFactor? number
---@return number
function EntityAgent.GetWalkSpeedMultiplier(groundDragFactor) end

-- Serializes the slots contents to be stored in the SaveGame
---@param writer BinaryWriter
---@param forClient boolean
function EntityAgent.ToBytes(writer, forClient) end

-- Loads the entity from a stored byte array from the SaveGame
---@param reader BinaryReader
---@param forClient boolean
function EntityAgent.FromBytes(reader, forClient) end

-- Attempts to stop the hand  action.
---@param isCancel boolean
---@param cancelReason? EnumItemUseCancelReason
---@return boolean
function EntityAgent.TryStopHandAction(isCancel, cancelReason) end

-- This walks the inventory for the entity agent.
---@param handler OnInventorySlot Return false to stop walking the inventory
function EntityAgent.WalkInventory(handler) end

function EntityAgent.UpdateDebugAttributes() end

---@param entityShape Shape&
---@param shapePathForLogging string
function EntityAgent.OnTesselation(entityShape, shapePathForLogging) end

---@param itemstack ItemStack
---@return boolean
function EntityAgent.TryGiveItemStack(itemstack) end
...
function EntityAgent.OnLoadCollectibleMappings(worldForResolve, oldBlockIdMapping, oldItemIdMapping, schematicSeed, resolveImports) end

---@param blockIdMapping table
---@param itemIdMapping table
function EntityAgent.OnStoreCollectibleMappings(blockIdMapping, itemIdMapping) end

---@param value function
function EntityAgent.add_OnInitialized(value) end

---@param value function
function EntityAgent.remove_OnInitialized(value) end
...
function EntityAgent.get_AnimManager() end
...
function EntityAgent.set_AnimManager(value) end

---@return boolean
function EntityAgent.get_IsOnFire() end

---@param value boolean
function EntityAgent.set_IsOnFire(value) end

---@return EntityProperties
function EntityAgent.get_Properties() end

---@return EntitySidedProperties
function EntityAgent.get_SidedProperties() end

---@return boolean
function EntityAgent.get_IsInteractable() end

---@return number
function EntityAgent.get_SwimmingOffsetY() end

---@return boolean
function EntityAgent.get_Collided() end

---@return EntityPos # Represents all positional information of an entity, such as coordinates, motion and angles
function EntityAgent.get_SidedPos() end

---@return Vec3d # Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
function EntityAgent.get_LocalEyePos() end

---@param value Vec3d Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
function EntityAgent.set_LocalEyePos(value) end

---@return boolean
function EntityAgent.get_ApplyGravity() end

---@return number
function EntityAgent.get_MaterialDensity() end

---@return number
function EntityAgent.get_LightHsv() end

---@param value number
function EntityAgent.set_LightHsv(value) end

---@return boolean
function EntityAgent.get_StoreWithChunk() end

---@return boolean
function EntityAgent.get_AlwaysActive() end

---@return boolean
function EntityAgent.get_Alive() end

---@param value boolean
function EntityAgent.set_Alive(value) end

---@return number
function EntityAgent.get_IdleSoundChanceModifier() end

---@param value number
function EntityAgent.set_IdleSoundChanceModifier(value) end

---@return number
function EntityAgent.get_RenderColor() end

---@return number
function EntityAgent.get_LadderFixDelta() end

-- Called when the entity got hurt. On the client side, dmgSource is null
---@param dmgSource DamageSource
---@param damage number
function EntityAgent.OnHurt(dmgSource, damage) end

---@param onFirstSpawn boolean
function EntityAgent.AfterInitialized(onFirstSpawn) end
...
---@return ItemStack[]
function EntityAgent.GetDrops(world, pos, byPlayer) end
...
function EntityAgent.GetInteractionHelp(world, es, player) end

-- Called by client when a new server pos arrived
---@param isTeleport boolean
function EntityAgent.OnReceivedServerPos(isTeleport) end
...
---@param data number
function EntityAgent.OnReceivedClientPacket(player, packetid, data) end
...
---@param packetid number
---@param data number
function EntityAgent.OnReceivedServerPacket(packetid, data) end

---@param activeAnimations number
---@param activeAnimationsCount number
---@param activeAnimationSpeeds number
function EntityAgent.OnReceivedServerAnimations(activeAnimations, activeAnimationsCount, activeAnimationSpeeds) end
...
---@return ItemStack
function EntityAgent.OnCollected(byEntity) end
...
function EntityAgent.OnStateChanged(beforeState) end

-- Helper method to set the CollisionBox
---@param length number
---@param height number
function EntityAgent.SetCollisionBox(length, height) end

---@param length number
---@param height number
function EntityAgent.SetSelectionBox(length, height) end
...
function EntityAgent.GetBehavior(name) end

---@return T
function EntityAgent.GetBehavior() end

-- Returns true if given activity is running
---@param key string
---@return boolean
function EntityAgent.IsActivityRunning(key) end

-- Returns the remaining time on an activity in milliesconds
---@param key string
---@return number
function EntityAgent.RemainingActivityTime(key) end

-- Starts an activity for a given duration
---@param key string
---@param milliseconds number
function EntityAgent.SetActivityRunning(key, milliseconds) end
...
function EntityAgent.FromBytes(reader, isSync, serversideRemaps) end

-- Revives the entity and heals for 9999.
function EntityAgent.Revive() end
...
function EntityAgent.WillExport(startPos) end
...
---@param startPos BlockPos A useful data structure when operating with block postions. Valuable Hint: Make use of Copy() or the XXXCopy() variants where needed. A common pitfall is writing code like: BlockPos abovePos = pos.Up(); - with this code abovePos and pos will reference to the same object!
function EntityAgent.DidImportOrExport(startPos) end
...
---@param oldItemIdMapping table
---@param schematicSeed number
function EntityAgent.OnLoadCollectibleMappings(worldForNewMappings, oldBlockIdMapping, oldItemIdMapping, schematicSeed) end

-- Gets the name for this entity
---@return string
function EntityAgent.GetName() end

-- gets the info text for the entity.
---@return string
function EntityAgent.GetInfoText() end

-- Starts the animation for the entity.
---@param code string
function EntityAgent.StartAnimation(code) end

-- stops the animation for the entity.
---@param code string
function EntityAgent.StopAnimation(code) end
...
function EntityAgent.CodeWithPath(path) end
...
---@return string
function EntityAgent.CodeWithoutParts(componentsToRemove) end
...
---@param componentsToRemove number
---@return string
function EntityAgent.CodeEndWithoutParts(componentsToRemove) end
...
---@return AssetLocation # Defines a complete path to an assets, including it's domain
function EntityAgent.CodeWithParts(components) end

-- More efficient version of CodeWithParts if there is only a single parameter
---@param component string
---@return AssetLocation # Defines a complete path to an assets, including it's domain
function EntityAgent.CodeWithParts(component) end

---@param type string
---@param value string
---@return AssetLocation # Defines a complete path to an assets, including it's domain
function EntityAgent.CodeWithVariant(type, value) end

---@param valuesByType table
---@return AssetLocation # Defines a complete path to an assets, including it's domain
function EntityAgent.CodeWithVariants(valuesByType) end

---@param types string
---@param values string
---@return AssetLocation # Defines a complete path to an assets, including it's domain
function EntityAgent.CodeWithVariants(types, values) end
...
---@return AssetLocation # Defines a complete path to an assets, including it's domain
function EntityAgent.CodeWithPart(part, atPosition) end
...
---@return string
function EntityAgent.LastCodePart(posFromRight) end
...
---@return string
function EntityAgent.FirstCodePart(posFromLeft) end
...
---@return boolean
function EntityAgent.WildCardMatch(wildcards) end
...
---@return boolean
function EntityAgent.WildCardMatch(wildCard) end
...
---@return userdata
function EntityAgent.GetType() end

---@return string
function EntityAgent.ToString() end

---@param obj userdata
---@return boolean
function EntityAgent.Equals(obj) end

---@return number
function EntityAgent.GetHashCode() end
