...
---@class InventoryCharacter: InventoryBasePlayer, IEnumerable, IInventory, InventoryBase, InventoryBasePlayer
---@field Count number
---@field Item ItemSlot
...
function InventoryCharacter.ctor(className, playerUID, api) end
---@param inventoryId string
---@param api ICoreAPI Common API Components that are available on the server and the client. Cast to ICoreServerAPI or ICoreClientAPI to access side specific features.
---@return InventoryCharacter
function InventoryCharacter.ctor(inventoryId, api) end

---@param slot ItemSlot The default item slot to item stacks
function InventoryCharacter.OnItemSlotModified(slot) end

---@return number
function InventoryCharacter.get_Count() end

---@param slotId number
---@return ItemSlot # The default item slot to item stacks
function InventoryCharacter.get_Item(slotId) end

---@param slotId number
---@param value ItemSlot The default item slot to item stacks
function InventoryCharacter.set_Item(slotId, value) end

---@param tree ITreeAttribute Represents a List of nestable Attributes
function InventoryCharacter.FromTreeAttributes(tree) end

---@param tree ITreeAttribute Represents a List of nestable Attributes
function InventoryCharacter.ToTreeAttributes(tree) end

function InventoryCharacter.DiscardAll() end

---@param pos Vec3d Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
function InventoryCharacter.OnOwningEntityDeath(pos) end

---@param sourceSlot ItemSlot The default item slot to item stacks
---@param op ItemStackMoveOperation
---@param skipSlots? table
---@return WeightedSlot
function InventoryCharacter.GetBestSuitedSlot(sourceSlot, op, skipSlots) end

---@return boolean
function InventoryCharacter.get_RemoveOnClose() end

---@return IPlayer # Represents a player
function InventoryCharacter.get_Player() end
...
---@return boolean
function InventoryCharacter.CanPlayerAccess(player, position) end

---@param player IPlayer Represents a player
---@return boolean
function InventoryCharacter.HasOpened(player) end

---@param pos Vec3d Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
---@param maxStackSize? number
function InventoryCharacter.DropAll(pos, maxStackSize) end

---@return Size3f # Represents a vector of 2 doubles. Go bug Tyron of you need more utility methods in this class.
function InventoryCharacter.get_MaxContentDimensions() end

---@param value Size3f Represents a vector of 2 doubles. Go bug Tyron of you need more utility methods in this class.
function InventoryCharacter.set_MaxContentDimensions(value) end

---@return string
function InventoryCharacter.get_InventoryID() end

---@return string
function InventoryCharacter.get_ClassName() end

---@return number
function InventoryCharacter.get_LastChanged() end

---@return number
function InventoryCharacter.get_CountForNetworkPacket() end

---@return boolean
function InventoryCharacter.get_IsDirty() end

---@return HashSet`1
function InventoryCharacter.get_DirtySlots() end

---@return boolean
function InventoryCharacter.get_TakeLocked() end

---@param value boolean
function InventoryCharacter.set_TakeLocked(value) end

---@return boolean
function InventoryCharacter.get_PutLocked() end

---@param value boolean
function InventoryCharacter.set_PutLocked(value) end

---@param value function
function InventoryCharacter.add_SlotModified(value) end

---@param value function
function InventoryCharacter.remove_SlotModified(value) end

---@param value function
function InventoryCharacter.add_SlotNotified(value) end

---@param value function
function InventoryCharacter.remove_SlotNotified(value) end

---@param value OnInventoryOpenedDelegate
function InventoryCharacter.add_OnInventoryOpened(value) end

---@param value OnInventoryOpenedDelegate
function InventoryCharacter.remove_OnInventoryOpened(value) end

---@param value OnInventoryClosedDelegate
function InventoryCharacter.add_OnInventoryClosed(value) end

---@param value OnInventoryClosedDelegate
function InventoryCharacter.remove_OnInventoryClosed(value) end

---@return boolean
function InventoryCharacter.get_Empty() end

---@return ItemSlot # The default item slot to item stacks
function InventoryCharacter.get_FirstNonEmptySlot() end
...
---@param inventoryID string
---@param api ICoreAPI Common API Components that are available on the server and the client. Cast to ICoreServerAPI or ICoreClientAPI to access side specific features.
function InventoryCharacter.LateInitialize(inventoryID, api) end

-- The event fired after all the blocks have loaded.
---@param world IWorldAccessor Important interface to access the game world.
function InventoryCharacter.AfterBlocksLoaded(world) end

-- Tells the invnetory to update blocks and items within the invnetory.
function InventoryCharacter.ResolveBlocksOrItems() end

-- Will return -1 if the slot is not found in this inventory
---@param slot ItemSlot The default item slot to item stacks
---@return number
function InventoryCharacter.GetSlotId(slot) end

---@param sourceSlot ItemSlot The default item slot to item stacks
---@param skipSlots table
---@return WeightedSlot
function InventoryCharacter.GetBestSuitedSlot(sourceSlot, skipSlots) end
...
---@return number
function InventoryCharacter.GetSuitability(sourceSlot, targetSlot, isMerge) end

---@param sinkSlot ItemSlot The default item slot to item stacks
---@param sourceSlot ItemSlot The default item slot to item stacks
---@return boolean
function InventoryCharacter.CanContain(sinkSlot, sourceSlot) end

-- Attempts to flip the contents of both slots
---@param targetSlotId number
---@param itemSlot ItemSlot The default item slot to item stacks
---@return userdata
function InventoryCharacter.TryFlipItems(targetSlotId, itemSlot) end

-- Determines whether or not the player can modify the invnetory.
---@param player IPlayer Represents a player
---@param position EntityPos Represents all positional information of an entity, such as coordinates, motion and angles
---@return boolean
function InventoryCharacter.CanPlayerModify(player, position) end

-- The event fired when the search is applied to the item.
---@param text string
function InventoryCharacter.OnSearchTerm(text) end

---@param slotId number
---@param sourceSlot ItemSlot The default item slot to item stacks
---@param op ItemStackMoveOperation&
---@return userdata
function InventoryCharacter.ActivateSlot(slotId, sourceSlot, op) end

-- Called when one of the containing slots has been modified
---@param slot ItemSlot The default item slot to item stacks
---@param extractedStack? ItemStack
function InventoryCharacter.DidModifyItemSlot(slot, extractedStack) end

-- Called when one of the containing slot was notified via NotifySlot
---@param slotId number
function InventoryCharacter.PerformNotifySlot(slotId) end
...
---@return boolean
function InventoryCharacter.TryFlipItemStack(owningPlayer, invIds, slotIds, lastChanged) end
...
---@param op ItemStackMoveOperation&
---@return boolean
function InventoryCharacter.TryMoveItemStack(player, invIds, slotIds, op) end
...
---@param slotIds number
---@return ItemSlot[] # The default item slot to item stacks
function InventoryCharacter.GetSlotsIfExists(player, invIds, slotIds) end
...
---@return ItemSlot[] # The default item slot to item stacks
function InventoryCharacter.SlotsFromTreeAttributes(tree, slots, modifiedSlots) end

-- Sets the tree attribute using the slots.
---@param slots ItemSlot[] The default item slot to item stacks
---@param tree ITreeAttribute Represents a List of nestable Attributes
function InventoryCharacter.SlotsToTreeAttributes(slots, tree) end

-- Gets a specified number of empty slots.
---@param quantity number
---@return ItemSlot[] # The default item slot to item stacks
function InventoryCharacter.GenEmptySlots(quantity) end
...
---@param slotId number
function InventoryCharacter.MarkSlotDirty(slotId) end

---@param slot ItemSlot The default item slot to item stacks
---@param player? IPlayer Represents a player
function InventoryCharacter.DropSlotIfHot(slot, player) end

-- Drops the contents of the specified slots in the world.
---@param pos Vec3d Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
---@param slotsIds number
function InventoryCharacter.DropSlots(pos, slotsIds) end

-- Deletes the contents of all the slots
function InventoryCharacter.Clear() end
...
---@return number
function InventoryCharacter.GetTransitionSpeedMul(transType, stack) end
...
---@param player IPlayer Represents a player
---@return userdata
function InventoryCharacter.Open(player) end
...
---@param player IPlayer Represents a player
---@return userdata
function InventoryCharacter.Close(player) end

-- Gets the enumerator for the inventory.
---@return function
function InventoryCharacter.GetEnumerator() end
...
---@return ItemSlot # The default item slot to item stacks
function InventoryCharacter.GetAutoPushIntoSlot(atBlockFace, fromSlot) end

-- Return the slot where a chute may pull items from. Return null if it is now allowed to pull any items from this inventory
---@param atBlockFace BlockFacing Represents one of the 6 faces of a cube and all it's properties. Uses a right Handed Coordinate System. See also http://www.matrix44.net/cms/notes/opengl-3d-graphics/coordinate-systems-in-opengl In short:  North: Negative Z East: Positive X South: Positive Z West: Negative X Up: Positive Y Down: Negative Y
---@return ItemSlot # The default item slot to item stacks
function InventoryCharacter.GetAutoPullFromSlot(atBlockFace) end

---@return userdata
function InventoryCharacter.GetType() end

---@return string
function InventoryCharacter.ToString() end

---@param obj userdata
---@return boolean
function InventoryCharacter.Equals(obj) end

---@return number
function InventoryCharacter.GetHashCode() end
