...
---@class HudIngameError: HudElement, IDisposable, GuiDialog, HudElement
...
---@return HudIngameError
function HudIngameError.ctor(capi) end

---@return number
function HudIngameError.get_InputOrder() end

---@return string
function HudIngameError.get_ToggleKeyCombinationCode() end

function HudIngameError.OnOwnPlayerDataReceived() end

function HudIngameError.ComposeGuis() end

---@return boolean
function HudIngameError.TryClose() end

---@return boolean
function HudIngameError.ShouldReceiveKeyboardEvents() end

---@param deltaTime number
function HudIngameError.OnRenderGUI(deltaTime) end

---@return boolean
function HudIngameError.get_Focusable() end

---@return EnumDialogType
function HudIngameError.get_DialogType() end

---@return boolean
function HudIngameError.get_PrefersUngrabbedMouse() end
...
function HudIngameError.get_SingleComposer() end
...
function HudIngameError.set_SingleComposer(value) end

---@return string
function HudIngameError.get_DebugName() end

---@return number
function HudIngameError.get_ZSize() end

---@return boolean
function HudIngameError.get_Focused() end

---@param value function
function HudIngameError.add_OnOpened(value) end

---@param value function
function HudIngameError.remove_OnOpened(value) end

---@param value function
function HudIngameError.add_OnClosed(value) end

---@param value function
function HudIngameError.remove_OnClosed(value) end

-- Makes this gui pop up once a pre-set given key combination is set.
function HudIngameError.OnBlockTexturesLoaded() end

function HudIngameError.OnLevelFinalize() end

---@return number
function HudIngameError.get_DrawOrder() end

---@return boolean
function HudIngameError.get_UnregisterOnClose() end

-- Fires when the GUI is opened.
function HudIngameError.OnGuiOpened() end

-- Fires when the GUI is closed.
function HudIngameError.OnGuiClosed() end

-- Attempts to open this dialogue.
---@return boolean
function HudIngameError.TryOpen() end

---@param withFocus boolean
---@return boolean
function HudIngameError.TryOpen(withFocus) end

-- Unfocuses the dialogue.
function HudIngameError.UnFocus() end

-- Focuses the dialog
function HudIngameError.Focus() end

-- If the dialogue is opened, this attempts to close it.  If the dialogue is closed, this attempts to open it.
function HudIngameError.Toggle() end

-- Is this dialogue opened?
---@return boolean
function HudIngameError.IsOpened() end

-- Is this dialogue opened in the given context?
---@param dialogComposerName string
---@return boolean
function HudIngameError.IsOpened(dialogComposerName) end

-- This runs before the render.  Local update method.
---@param deltaTime number
function HudIngameError.OnBeforeRenderFrame3D(deltaTime) end

-- This runs when the dialogue is finalizing and cleaning up all of the components.
---@param dt number
function HudIngameError.OnFinalizeFrame(dt) end

-- Fires when keys are held down.
---@param args KeyEvent
function HudIngameError.OnKeyDown(args) end

-- Fires when the keys are pressed.
---@param args KeyEvent
function HudIngameError.OnKeyPress(args) end

-- Fires when the keys are released.
---@param args KeyEvent
function HudIngameError.OnKeyUp(args) end

-- Fires explicitly when the Escape key is pressed and attempts to close the dialogue.
---@return boolean
function HudIngameError.OnEscapePressed() end

-- Fires when the mouse enters the given slot.
---@param slot ItemSlot The default item slot to item stacks
---@return boolean
function HudIngameError.OnMouseEnterSlot(slot) end

-- Fires when the mouse leaves the slot.
---@param itemSlot ItemSlot The default item slot to item stacks
---@return boolean
function HudIngameError.OnMouseLeaveSlot(itemSlot) end

-- Fires when the mouse clicks within the slot.
---@param itemSlot ItemSlot The default item slot to item stacks
---@return boolean
function HudIngameError.OnMouseClickSlot(itemSlot) end

-- Fires when a mouse button is held down.
---@param args MouseEvent This contains the data for what the mouse is currently doing.
function HudIngameError.OnMouseDown(args) end

-- Fires when a mouse button is released.
---@param args MouseEvent This contains the data for what the mouse is currently doing.
function HudIngameError.OnMouseUp(args) end

-- Fires when the mouse is moved.
---@param args MouseEvent This contains the data for what the mouse is currently doing.
function HudIngameError.OnMouseMove(args) end

-- Fires when the mouse wheel is scrolled.
---@param args MouseWheelEventArgs The event arguments for the mouse.
function HudIngameError.OnMouseWheel(args) end

-- A check for whether the dialogue should recieve Render events.
---@return boolean
function HudIngameError.ShouldReceiveRenderEvents() end

-- A check if the dialogue should recieve mouse events.
---@return boolean
function HudIngameError.ShouldReceiveMouseEvents() end

---@return boolean
function HudIngameError.RequiresUngrabbedMouse() end

---@return boolean
function HudIngameError.get_DisableMouseGrab() end

-- Should this dialog (e.g. textbox) capture all the keyboard events except for escape.
---@return boolean
function HudIngameError.CaptureAllInputs() end
...
---@return boolean
function HudIngameError.CaptureRawMouse() end

-- Disposes the Dialog.
function HudIngameError.Dispose() end

-- Clears the composers.
function HudIngameError.ClearComposers() end

-- Checks if the player is in range (pickingrange) of the given position
---@param pos Vec3d Represents a vector of 3 doubles. Go bug Tyron of you need more utility methods in this class.
---@return boolean
function HudIngameError.IsInRangeOf(pos) end

---@return userdata
function HudIngameError.GetType() end

---@return string
function HudIngameError.ToString() end

---@param obj userdata
---@return boolean
function HudIngameError.Equals(obj) end

---@return number
function HudIngameError.GetHashCode() end
