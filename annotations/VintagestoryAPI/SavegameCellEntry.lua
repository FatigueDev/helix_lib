...
---@return SavegameCellEntry
function SavegameCellEntry.ctor() end

---@return userdata
function SavegameCellEntry.GetType() end

---@return string
function SavegameCellEntry.ToString() end

---@param obj userdata
---@return boolean
function SavegameCellEntry.Equals(obj) end

---@return number
function SavegameCellEntry.GetHashCode() end
